...
import { CardModule,TooltipModule,SidebarModule,DialogModule,OverlayPanelModule,LightboxModule,
  ConfirmDialogModule, InputTextModule,  ButtonModule,  RadioButtonModule,  ChartModule} from 'primeng-wl/primeng';
