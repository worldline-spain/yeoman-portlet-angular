...
`
        ...
        this.fs.copyTpl(
            this.templatePath('src/main/resources/META-INF/resources/js/about/about.component.ts'),
            this.destinationPath(`./${userVariables.portletName}/src/main/resources/META-INF/resources/js/about/about.component.ts`),
            userVariables
        );
        this.fs.copyTpl(
            this.templatePath('src/main/resources/META-INF/resources/js/home/home.component.ts'),
            this.destinationPath(`./${userVariables.portletName}/src/main/resources/META-INF/resources/js/home/home.component.ts`),
            userVariables
        );
        this.fs.copyTpl(
